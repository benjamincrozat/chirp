...
class TwitterOAuth extends Config
{
     ...
     */
    protected function resetAttemptsNumber()
    {
        $this->attempts = 0;
    }
     ...
     */
    protected function sleepIfNeeded()
    {
     ...
     * @return array|object
     */
    protected function uploadMediaNotChunked($path, array $parameters)
    {
        if (! is_readable($parameters['media']) ||
            false === ($file = file_get_contents($parameters['media']))) {
     ...
     * @return array|object
     */
    protected function uploadMediaChunked($path, array $parameters)
    {
     ...
     * @return array
     */
    protected function cleanUpParameters(array $parameters)
    {
     ...
     * @return array|object
     */
    protected function makeRequests($url, $method, array $parameters, $json)
    {
        do {
            $this->sleepIfNeeded();
     ...
     * @return bool
     */
    protected function requestsAvailable()
    {
     ...
     * @throws TwitterOAuthException
     */
    protected function oAuthRequest($url, $method, array $parameters, $json = false)
    {
     ...
     * @throws TwitterOAuthException
     */
    protected function request($url, $method, $authorization, array $postfields, $json = false)
    {
